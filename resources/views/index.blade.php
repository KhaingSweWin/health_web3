        ...
        <div class="row align-items-center">
          ...
          <div class="col-lg-6 wow fadeInRight" data-wow-delay="400ms">
            <div class="img-place custom-img-1">
              <img src="{{asset('/img/bg-doctor.png')}}" alt="">
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row mt-5">
        ...
        <div class="col-lg-4 py-2 wow zoomIn">
          <div class="card-blog">
            ...
            <div class="body">
              <h5 class="post-title"><a href="blog-details">Recovery Room: News beyond the pandemic</a></h5>
              <div class="site-info">
                <div class="avatar mr-2">
                  <div class="avatar-img">
                    <img src="/img/person/person_1.jpg" alt="">
        ...
        <div class="col-lg-4 py-2 wow zoomIn">
          <div class="card-blog">
            ...
            <div class="body">
              <h5 class="post-title"><a href="blog-details">What is the impact of eating too much sugar?</a></h5>
              <div class="site-info">
                <div class="avatar mr-2">
                  <div class="avatar-img">
